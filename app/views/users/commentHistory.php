            ...
            <div class="col-xl-4">
                ...
                <div class="d-flex flex-column gap-1">
                    <div class="d-flex align-items-center gap-1 w-full p-3 bg-white round-8 shadow-sm">
                        <a href="<?php echo BASEPATH ?>/user/changePwd"
                           class="w-full text-decoration-none text-dark text-bold"><i class="me-2 fa-solid fa-lock"></i>Đổi
                            mật khẩu</a>
                    </div>
                    <div class="d-flex align-items-center gap-1 w-full p-3 bg-white round-8 shadow-sm">
                        <a href="<?php echo BASEPATH ?>/user/orderHistory"
                           class="w-full text-decoration-none text-dark text-bold"><i
                                    class="me-2 fa-solid fa-clock-rotate-left"></i>Lịch sử mua hàng</a>
                    </div>
                    <div class="d-flex align-items-center gap-1 w-full p-3 bg-white round-8 shadow-sm">
                        <a href="<?php echo BASEPATH ?>/user/commentHistory"
                           class="w-full text-decoration-none text-dark text-bold"><i class="me-2 fa-solid fa-star"></i>Lịch
                            sử bình luận</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-8">
                <div class="w-full p-3 bg-white round-8">
                    <div class="d-flex justify-content-between align-items-content">
                        <h3 class="heading-3">Lịch sử bình luận</h3>
                    </div>
                    <div>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href='" . BASEPATH . "/admin/comments/delete?commentId=$comment[comment_id]&back=users' class='me-2'><i class='fa-solid fa-trash'></i></a>
                                        </td>
                                    </tr>
                                    ";
                                    }
