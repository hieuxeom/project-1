...
class AdminModel extends BaseModel
{
    ...
    public function createOTP($userId)
    {
        ...
        $this->insert(table: self::OTP_TABLE, data: [
            "user_id" => $userId,
            "otp_code" => $otpCode,
        ]);
    ...
    public function sendMail($userData)
    {
        ...
        $otpCode = $this->createOTP($userData["user_id"]);
        ...
        try {
            ...
            $mail->Subject = 'Yêu cầu đổi mật khẩu?';
            $mail->Body = $this->generateBodyEmail(receiverName: $receiverName, otpCode: $otpCode);
    ...
    private function generateBodyEmail($receiverName, $otpCode)
    {
                  ...
                  <tr>
                    <td class='content-cell'>
                      <div class='f-fallback'>
                        <h1 style='font-weight: normal'>Chào <strong>{$receiverName}</strong>,</h1>
                        <p>Chúng tôi nhận được yêu cầu lấy mã OTP đổi mật khẩu từ tài khoản của bạn trên <strong>ShopBake</strong></p>
                        <p>Dưới đây là mã của bạn, mã có hiệu lực trong 24 giờ.</p>
                          ...
                          <tr>
                            <td align='center'>
                              <table width='100%' border='0' cellspacing='0' cellpadding='0' role='presentation'>
                                <tr>
                                  <td align='center'>
                                    <p class='f-fallback button button--green' target='_blank'><strong>$otpCode</strong></p>
                                  </td>
                                </tr>
                              </table>
                            </td>
                        ...
                        <p>Vui lòng không cung cấp mã này cho bất kfi ai, kể cả Quản trị viên trang web.</p>
                        <p>Cảm ơn,
                          <br>ShopBake team</p>
                        <table class='body-sub' role='presentation'>
                          <tr>
                            <td>
                              <p class='f-fallback sub'>Liên hệ chúng tôi qua <strong>support.shopbake@hieutn.xyz</strong> nếu bạn có bất kì câu hỏi nào</p>
                            </td>
                          </tr>
                        </table>
                      </div>
